...
public class Student extends JFrame {
    ...
    public Student(String username, String password, Connection connection) throws Exception {
        ...
        Borrowbook.setBounds(0, 40, 90, 30);
        con.add(Borrowbook);

        Returnbook = new JButton("还书");
        Returnbook.setBounds(90, 40, 90, 30);
        con.add(Returnbook);

        own = new JButton("个人信息");
        own.setBounds(180, 40, 90, 30);
        con.add(own);
        ...
        comboBox.addActionListener(e -> {
            ...
            if ("更改密码".equals(myselectitem)) {
                ...
                if (newpassword == null || newpassword.trim().isEmpty()) {
                    ...
                    String sql = "UPDATE userstu SET spassword = ? WHERE sno = ?";
